import fresh_tomatoes   # module which includes the code to create an html page
# and fetch the movie info to the webpage
...
dark_knight=media.Movie("The Dark Knight",
                        ...
                        the Dark Knight must accept
                        one of the greatest psychological
                        and physical tests of his
                        ability to fight injustice.""",
                        "http://www.impawards.com/2008/posters/dark_knight.jpg"  # noqa,
...
interstellar=media.Movie("Interstellar",
                        """A team of explorers travel through a wormhole in space
                         ...
                         "http://www.joblo.com/timthumb.php?src=/posters/images/full/interstellar-mcconaughey.jpg&h=600&q=100"  # noqa,
...
pulp_fiction=media.Movie("Pulp Fiction",
                         ...
                         "http://www.impawards.com/1994/posters/pulp_fiction.jpg"  # noqa,
                         "https://www.youtube.com/watch?v=s7EdQ4FqbhY")

movies=[shawshank_redemption, dark_knight,
fightclub, interstellar,
forrest_gump, pulp_fiction]   # list of movies instances.
# The module fresh tomatoes.py fetches the info of the movie instance
# mentioned in this list only to display on the webpage.
fresh_tomatoes.open_movies_page(movies)
# function defined in fresh tomatoes.py
# to open the movies page and display
# the movie info of the movies listed in the list "movies"
